...
class KeyboardListner:
    ...
    def __init__(self, game_window, master, canvas):
        self.game_window = game_window
        self.master = master
        self.player = game_window.get_player()
        self.canvas = canvas
        self.ARROW_UP = "Up"
...
# keyboard listner  -----------------------
input_listner = KeyboardListner(game_window=game_window, master=master, canvas=canvas)
...
master.bind("<Configure>", lambda event, canvas=canvas, game_window=game_window, center_element=player, master=master: resize_window(event, canvas, master, game_window))
